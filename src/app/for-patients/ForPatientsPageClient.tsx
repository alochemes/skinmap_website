...
const faqs = [
  {
    ...
    a: 'Your physician uses the skinmap iPhone app to photograph any skin lesions during your regular appointment — it takes under 10 seconds per lesion. The AI instantly provides a risk assessment. No extra equipment, no separate visit, no disruption to your care.',
  },
  {
    q: 'Is there any cost to me as a patient?',
    a: 'skinmap is a tool used by your physician — you pay nothing for the technology itself. Any visit-related costs depend on your insurance and your provider\'s billing practices, just like any other part of your appointment.',
  },
  {
    q: 'How do I ask my doctor about skinmap?',
    a: 'At your next appointment, simply say: "I heard about an AI tool called skinmap that tracks skin health over time — do you use it, or is it something you\'d consider?" That\'s all it takes. If they\'re not familiar, you can point them to skinmap.com.',
  },
  {
    q: 'What happens if my doctor isn\'t on the map yet?',
    a: 'Use the "Request skinmap in my area" form below. We\'ll note your location in our deployment planning and reach out to practices near you. You can also send your doctor directly to skinmap.com/contact to request access.',
  },
];
      ...
      <section className="bg-navy py-10 border-y border-white/5" aria-label="Trust signals">
        <Container>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            {[
              { Icon: Shield,      label: 'HIPAA Compliant',        sub: 'Patient data is always protected' },
              { Icon: Stethoscope, label: 'Physician-Led',          sub: 'Used by licensed clinicians only' },
              { Icon: Clock,       label: 'Under 10 Seconds',       sub: 'Per lesion at your appointment' },
              { Icon: CheckCircle, label: '90% Accuracy',           sub: 'Sensitivity and specificity in testing' },
            ].map(({ Icon, label, sub }) => (
