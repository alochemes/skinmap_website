          ...
          <div className="max-w-3xl relative z-10">
            ...
            <FadeUp delay={0.2}>
              <p className="text-lg text-navy-100 leading-relaxed mb-10 max-w-2xl">
                ...
                closes that access gap with clinical-grade AI in the physician&apos;s pocket, at
                the point of care, at every appointment.
              </p>
            </FadeUp>
            <FadeUp delay={0.3}>
                ...
                {[
                  {
                    ...
                    detail: '90% sensitivity · 90% specificity · IRB-approved study',
